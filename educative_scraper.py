...
def load_chrome_driver(headless=True):
    global chromedriver, chrome_mac
    ...
    options.binary_location = os.path.join(chrome_exe, chrome_mac)
...
def generate_config():
    clear()
    print('''
        Please install Chrome Portable version 92.0.4515.107 (64-bit) in your Win/Mac OS and provide the following details
        Link for Portable Google Chrome : https://drive.google.com/drive/folders/17bwSQAgD9laICioaiqarkLH42dxKpgCX?usp=sharing
        Extract the archives and copy the paths of chrome.exe or Chromium.app for Win and MacOS respectively.
